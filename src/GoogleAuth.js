  ...
  return (
    <ContainerCenter>
      ...
      {isLogined ? (
        ...
        <GoogleLogin clientId={clientId} buttonText='Login' onSuccess={handleSuccess} onFailure={onLogInFailure} cookiePolicy={'single_host_origin'} responseType='code,token' />
      )}
    </ContainerCenter>
  );
}
